  ...
  return (
    <Layout image={image} title={title} subTitle={subTitle}>
      ...
      <section className={styles.footer}>
        ...
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non amet ac
          velit velit eget. Risus est, risus ac vitae eu. Amet, morbi semper eu,
          amet sed sit in. Maecenas imperdiet enim dignissim amet fermentum,
          velit at.
        </p>
...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const image = urlFor(data?.header?.background)
    .auto('format')
    .url()
    .toString();
