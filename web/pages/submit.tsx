    ...
    <Layout image={image} title={title} subTitle={subTitle}>
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          try {
            ...
            //   body: formData,
            // });
            for (const t of formData.entries()) {
              console.log(t);
            }
          } catch (err) {
      ...
      >
        <fieldset>
          ...
          <input name="event-link" placeholder="URL" aria-describedby="event-link-help-text" className={styles.input} />
        ...
        <fieldset>
          ...
          <input type="checkbox" name="agree" className={styles.input} />
        </fieldset>
        <p>
          <button className={styles.button}>Send inn arrangement</button>
        </p>
